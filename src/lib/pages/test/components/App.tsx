import { Box, Button, Divider, Flex, Stack, StackDivider, Text, useColorModeValue as mode } from '@chakra-ui/react'
      ...
      <Box maxW={{ base: 'xl', md: '7xl' }} mx="auto" px={{ md: '8' }}>
        <Box rounded={{ lg: 'lg' }} bg={mode('white', 'gray.700')} maxW="3xl" mx="auto" shadow="base" overflow="hidden">
          ...
          <Stack spacing="6" py="5" px="8" divider={<StackDivider />}>
            <Description title="UX Strategist &amp; Sales Funnel Designer" location="Los Angeles, United States">
